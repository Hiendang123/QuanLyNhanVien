...
var officeCodeEl = document.querySelector("#office-code");
...
function regitrationData() {
  userData.push({
    ...
    profilePic: imgUrl == undefined ? "img/avata.jpg" : imgUrl,
  });
  console.log(userData); // Kiểm tra dữ liệu trước khi lưu
  var userString = JSON.stringify(userData);
  localStorage.setItem("userData", userString);
  swal("Good job!", "Registered Success", "success");
}
  ...
  for (i = 0; i < allEdit.length; i++) {
    allEdit[i].onclick = function () {
      ...
      updateBtn.onclick = function (e) {
        ...
        // Cập nhật lại dữ liệu trong Local Storage
